...
$solutions = @(
    @{ Label = "1. Gantt";            File = "PumPowerGanttSolution_4.3.0.zip" }
    @{ Label = "2. Essentials";       File = "PowerPPMEssentials_4.0.0.1.zip" }
    @{ Label = "3. Resource Planner"; File = "ResourcePlan_1.0.0.31.zip" }
)
...
Write-Host "  RETRY SUMMARY  (total: $([int]$stopwatch.Elapsed.TotalMinutes) min)" -ForegroundColor White
