<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_financialstructure`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_financialstructure -->

# PumFinancialstructure (`pum_financialstructure`)
...
| `pum_financialstructureid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_guid` | String |  | max length 4000 |
| `statuscode` | Status |  |  |
