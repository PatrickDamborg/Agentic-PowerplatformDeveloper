<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_powerboardconfig`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_powerboardconfig -->

# PumPowerboardconfig (`pum_powerboardconfig`)
...
| `pum_powerboardconfigid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
