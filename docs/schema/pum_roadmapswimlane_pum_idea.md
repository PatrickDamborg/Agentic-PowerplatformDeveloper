<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_roadmapswimlane_pum_idea`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_roadmapswimlane_pum_idea -->

# PumRoadmapswimlanePumIdea (`pum_roadmapswimlane_pum_idea`)
...
| `pum_roadmapswimlane_pum_ideaid` | Uniqueidentifier | ✓ |  |
