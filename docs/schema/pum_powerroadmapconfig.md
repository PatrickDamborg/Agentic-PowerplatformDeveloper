<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_powerroadmapconfig`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_powerroadmapconfig -->

# PumPowerroadmapconfig (`pum_powerroadmapconfig`)
...
| `pum_powerroadmapconfigid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_identifier` | String |  | max length 500 |
| `pum_jsonvalue` | Memo |  | max length 100000 |
| `pum_uniqueidentifier` | String |  | max length 1000 |
| `statuscode` | Status |  |  |
