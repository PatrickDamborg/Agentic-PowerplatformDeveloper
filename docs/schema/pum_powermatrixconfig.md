<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_powermatrixconfig`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_powermatrixconfig -->

# PumPowermatrixconfig (`pum_powermatrixconfig`)
...
| `pum_powermatrixconfigid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
