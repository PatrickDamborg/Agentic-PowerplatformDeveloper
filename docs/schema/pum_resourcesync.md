<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_resourcesync`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_resourcesync -->

# PumResourcesync (`pum_resourcesync`)
...
| `pum_resourcesyncid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_lastupdateddate` | DateTime |  | date-time (ISO 8601) |
| `pum_partial` | Boolean |  |  |
| `statuscode` | Status |  |  |
