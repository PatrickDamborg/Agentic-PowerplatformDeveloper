<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_ganttmarker`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_ganttmarker -->

# PumGanttmarker (`pum_ganttmarker`)
...
| `pum_ganttmarkerid` | Uniqueidentifier | ✓ |  |
