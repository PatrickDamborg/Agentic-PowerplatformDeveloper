<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_resource_request`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_resource_request -->

# PumResourceRequest (`pum_resource_request`)
...
| `pum_resource_requestid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `_pum_relatedtask_value` | Lookup |  | Lookup → pum_gantttask; write `pum_RelatedTask@odata.bind` = `/pum_gantttasks({id})` |
