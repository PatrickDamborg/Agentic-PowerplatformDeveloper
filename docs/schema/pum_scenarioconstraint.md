<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_scenarioconstraint`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_scenarioconstraint -->

# PumScenarioconstraint (`pum_scenarioconstraint`)
...
| `pum_scenarioconstraintid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_columnname` | String |  | max length 200 |
| `pum_limit` | Decimal |  | range -100000000000..100000000000; 2 decimals |
