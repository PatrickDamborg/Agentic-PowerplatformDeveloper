<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_powerganttconfig`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_powerganttconfig -->

# PumPowerganttconfig (`pum_powerganttconfig`)
...
| `pum_powerganttconfigid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_enablecomaddin` | Boolean |  |  |
| `pum_identifier` | String |  | max length 100 |
| `pum_jsonvalue` | Memo |  | max length 500000 |
| `pum_uniqueidentifier` | String |  | max length 100 |
| `statuscode` | Status |  |  |
