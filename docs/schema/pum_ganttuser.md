<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_ganttuser`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_ganttuser -->

# PumGanttuser (`pum_ganttuser`)
...
| `pum_ganttuserid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `_pum_referenceuser_value` | Lookup |  | Lookup → systemuser; write `pum_referenceuser@odata.bind` = `/systemusers({id})` |
| `statuscode` | Status |  |  |
