<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_ganttsession`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_ganttsession -->

# PumGanttsession (`pum_ganttsession`)
...
| `pum_ganttsessionid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_lastaccessed` | DateTime |  | date-time (ISO 8601) |
| `_pum_project_value` | Lookup |  | Lookup → pum_initiative; write `pum_Project@odata.bind` = `/pum_initiatives({id})` |
