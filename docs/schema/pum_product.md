<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_product`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_product -->

# PumProduct (`pum_product`)
...
| `pum_productid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_ofactiveepics` | Integer |  | range -2147483648..2147483647 |
| `pum_ofactiveepics_date` | DateTime |  | date-time (ISO 8601) |
| `pum_ofactiveepics_state` | Integer |  | range -2147483648..2147483647 |
| `pum_ofactivefeatures` | Integer |  | range -2147483648..2147483647 |
| `pum_ofactivefeatures_date` | DateTime |  | date-time (ISO 8601) |
| `pum_ofactivefeatures_state` | Integer |  | range -2147483648..2147483647 |
