<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_resourceplan`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_resourceplan -->

# PumResourceplan (`pum_resourceplan`)
...
| `pum_resourceplanid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_comment` | Memo |  | max length 100000 |
| `pum_earlieststart` | DateTime |  | date-time (ISO 8601) |
| `pum_earlieststart_date` | DateTime |  | date-time (ISO 8601) |
| `pum_earlieststart_state` | Integer |  | range -2147483648..2147483647 |
| `_pum_idea_value` | Lookup |  | Lookup → pum_idea; write `pum_Idea@odata.bind` = `/pum_ideas({id})` |
| `pum_index` | Integer |  | range 0..2147483647 |
| `_pum_initiative_value` | Lookup |  | Lookup → pum_initiative; write `pum_Initiative@odata.bind` = `/pum_initiatives({id})` |
| `pum_latestfinish` | DateTime |  | date-time (ISO 8601) |
| `pum_latestfinish_date` | DateTime |  | date-time (ISO 8601) |
| `pum_latestfinish_state` | Integer |  | range -2147483648..2147483647 |
...
| `pum_state` | Picklist |  |  |
| `pum_work` | Decimal |  | range -100000000000..100000000000; 2 decimals |
| `pum_work_date` | DateTime |  | date-time (ISO 8601) |
| `pum_work_state` | Integer |  | range -2147483648..2147483647 |
| `statuscode` | Status |  |  |
