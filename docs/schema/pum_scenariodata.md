<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_scenariodata`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_scenariodata -->

# PumScenariodata (`pum_scenariodata`)
...
| `pum_scenariodataid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_mustrun` | Boolean |  |  |
| `_pum_parentitem_value` | Lookup |  | Lookup → pum_scenariodata; write `pum_ParentItem@odata.bind` = `/pum_scenariodatas({id})` |
