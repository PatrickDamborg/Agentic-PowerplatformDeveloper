<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_investmentcategory`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_investmentcategory -->

# PumInvestmentcategory (`pum_investmentcategory`)
...
| `pum_investmentcategoryid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
