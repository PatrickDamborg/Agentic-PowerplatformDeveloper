<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_ganttteam`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_ganttteam -->

# PumGanttteam (`pum_ganttteam`)
...
| `pum_ganttteamid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
