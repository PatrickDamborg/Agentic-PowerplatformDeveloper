<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_initiativebusinessprocess`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_initiativebusinessprocess -->

# PumInitiativebusinessprocess (`pum_initiativebusinessprocess`)
...
| `_bpf_pum_initiativeid_value` | Lookup |  | Lookup → pum_initiative; write `bpf_pum_initiativeid@odata.bind` = `/pum_initiatives({id})` |
