<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_nationalholiday`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_nationalholiday -->

# PumNationalholiday (`pum_nationalholiday`)
...
| `pum_nationalholidayid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_date` | DateTime |  | date-time (ISO 8601) |
| `statuscode` | Status |  |  |
