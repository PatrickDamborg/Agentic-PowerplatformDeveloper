<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_timeincrement`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_timeincrement -->

# PumTimeincrement (`pum_timeincrement`)
...
| `pum_timeincrementid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
