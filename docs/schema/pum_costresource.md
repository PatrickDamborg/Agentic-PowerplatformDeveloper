<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_costresource`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_costresource -->

# PumCostresource (`pum_costresource`)
...
| `pum_costresourceid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
