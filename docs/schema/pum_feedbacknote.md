...
| `pum_authorinitials` | String |  | max length 20 |
| `pum_authorupn` | String |  | max length 320 |
| `pum_columnkey` | String |  | max length 200 |
| `pum_notetext` | Memo |  | max length 4000 |
| `pum_rowkey` | String |  | max length 200 |
| `statuscode` | Status |  |  |
