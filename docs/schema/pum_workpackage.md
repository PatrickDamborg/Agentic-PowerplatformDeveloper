<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_workpackage`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_workpackage -->

# PumWorkpackage (`pum_workpackage`)
...
| `pum_workpackageid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
