<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_roadmapincrements`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_roadmapincrements -->

# PumRoadmapincrements (`pum_roadmapincrements`)
...
| `pum_roadmapincrementsid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
