<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_powermatrixdata`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_powermatrixdata -->

# PumPowermatrixdata (`pum_powermatrixdata`)
...
| `pum_powermatrixdataid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_columnindex` | Integer |  | range -2147483648..2147483647 |
| `pum_rowindex` | Integer |  | range -2147483648..2147483647 |
| `pum_score` | Decimal |  | range -100000000000..100000000000; 2 decimals |
| `pum_x` | Integer |  | range -2147483648..2147483647 |
| `pum_y` | Integer |  | range -2147483648..2147483647 |
| `statuscode` | Status |  |  |
