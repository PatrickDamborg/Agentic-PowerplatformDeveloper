<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_powerfinancialsconfig`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_powerfinancialsconfig -->

# PumPowerfinancialsconfig (`pum_powerfinancialsconfig`)
...
| `pum_powerfinancialsconfigid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_uniqueidentifier` | String |  | max length 200 |
| `statuscode` | Status |  |  |
