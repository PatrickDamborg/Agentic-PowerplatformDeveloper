<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_changerequest`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_changerequest -->

# PumChangerequest (`pum_changerequest`)
...
| `pum_changerequestid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `_pum_approver_value` | Lookup |  | Lookup → systemuser; write `pum_Approver@odata.bind` = `/systemusers({id})` |
| `pum_changeno` | String |  | max length 100 |
| `pum_dateapproved` | DateTime (date-only) |  | date (ISO 8601) |
