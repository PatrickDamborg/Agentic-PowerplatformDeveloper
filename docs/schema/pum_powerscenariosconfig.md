<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_powerscenariosconfig`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_powerscenariosconfig -->

# PumPowerscenariosconfig (`pum_powerscenariosconfig`)
...
| `pum_powerscenariosconfigid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
...
| `pum_identifier` | String |  | max length 250 |
| `pum_jsonvalue` | Memo |  | max length 1048576 |
| `pum_uniqueidentifier` | String |  | max length 250 |
| `statuscode` | Status |  |  |
