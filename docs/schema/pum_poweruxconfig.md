<!-- GENERATED — do not edit by hand.
     Source: live EntityDefinitions for `pum_poweruxconfig`
     Env:    https://esben.crm.dynamics.com
     Date:   2026-06-16
     Regenerate: uv run python cli.py gen-schema pum_poweruxconfig -->

# PumPoweruxconfig (`pum_poweruxconfig`)
...
| `pum_poweruxconfigid` | Uniqueidentifier | ✓ |  |
| `statecode` | State | ✓ |  |
